...
class PAYOUTRECEIPTTPDF extends TCPDF {
...
$obj_pdf = new PAYOUTRECEIPTTPDF('P', PDF_UNIT, PDF_PAGE_FORMAT, true, 'UTF-8', false);
...
// $obj_pdf->Output('output.pdf', 'I');
 ...
 $obj_pdf->Output(RECEIPT_PATH.'customer/'.$inv->{'inv_id'}.'.pdf', 'F');
 
 if ($display == 1)
  	$obj_pdf->Output(RECEIPT_PATH.'customer/'.$inv->{'inv_id'}.'.pdf', 'I');

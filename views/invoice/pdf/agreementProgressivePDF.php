...
<li>The Contract Holder shall within 14 days approve the redemption by the Funder and within 30 days reimburse the Funder in accordance to the following:
	...
	<li>(b)	If the redemption is done within the second year to the end of the funding period, the Funder shall receive the full funding sum of SGD$<?php echo number_format($inv->{"inv_total"},2,'.',',');?> plus the monthly returns accrued at the time of the redemption.
	</li>
	</ol>

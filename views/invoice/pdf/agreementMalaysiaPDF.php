...
//     	$this->Cell(105, 18, 'Sales & Purchase', 0, 0, 'R', 0, '', 0, false, 'C', 'B');
    ...
    public function Footer() {
        ...
        // Page number
        $this->Cell(0, 2, $this->getAliasNumPage(). ' | Private and confidential    v4.2 18.11.14', 'T', false, 'L', 0, '', 0, false, 'T', 'L');
...
<li>The Contract Holder shall within 14 days approve the redemption by the Funder and within 30 days reimburse the Funder in accordance to the following:
	<ol style="list-style-type:lower-alpha;">
	<li>A minimum holding period of 1 year is required and no redemption can be done within the first year of the funding period. </li><br/><br/>
	<li>If the redemption is done within the second year to the end of the funding period, the Funder shall receive the full funding sum of SGD$10,000 plus the monthly returns accrued at the time of the redemption.</li><br/><br/>
...
<ol style="list-style-type:lower-alpha;">
<li>The Contract Holder shall pay to the Funder the sum of SGD$<?php echo number_format($inv->{'inv_total'} * 0.01,2,'.',',');?> per month in accordance to Annex A.</li>
...
<tr>
	<td colspan="3">
		<br/>
	  <img src="images/checkbox.png"> I have done my due diligence on the company and the business. However, I have considered the     financial risks involved in funding and I wish to proceed with opening a funding account.
<br/>
       <img src="images/checkbox.png"> I have been asked to do a due diligence on the company and the business. I have voluntarily exercised my right to waive the due diligence on the company and the business. I understand that the waiver is done at my own risk.
	</td>
</tr>

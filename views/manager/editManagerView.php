        ...
        <div class="col-md-9">
          <div class="block-web">
            ...
            <?php 
              ...
              ?>
             	<form class="form-horizontal" method="post" action="<?php echo base_url();?>manager/editManager">
					...
					<div class="form-group">
					  ...
					  <div class="col-sm-9">
						<input type="password" name="m_pass" value="<?php echo set_value('m_pass', $m_pass);?>" placeholder="Leave blank if unchanged" autocomplete="off" class="form-control">
					  </div>
					  </div>
						...
						<select name="m_upline">
							...
							<?php if (isset($directors) && count($directors) > 0) {
								foreach ($directors as $d) {
									$selected = '';
									if (isset($m_upline) && $m_upline == $d->{'dr_id'})
										$selected = 'selected="selected"';
										
									echo '<option value="'.$d->{'dr_id'}.'" '.$selected.'>'.$d->{'dr_name'}.' ('.$d->{'dr_code'}.')</option>';
								}
							}
							?>
						</select>
					  ...
					  <div class="col-sm-9">
						...
						<input type="text" name="m_code" value="<?php echo set_value('m_code', $m_code);?>" class="form-control">
					  </div>
					  </div>
					</div>
					...
					<input type="hidden" name="m_id" value="<?php echo $manager->{'m_id'};?>"/>
				</form>
            </div><!--/porlets-content-->
          </div><!--/block-web--> 
        </div><!--/col-md-12--> 

        ...
        <div class="col-md-9">
          <div class="block-web">
            ...
            <div class="porlets-content">
              ...
              ?>
             	<form class="form-horizontal" method="post" action="<?php echo base_url();?>admin/addAdmin">
					...
					<div class="form-group">
					  ...
					  <div class="col-sm-9">
						...
						<input type="password" name="admin_pass" value="<?php echo set_value('admin_pass', $admin_pass);?>" autocomplete="off" class="form-control">
					  </div>
					  </div>

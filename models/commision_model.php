...
class Commision_model extends CI_Model {
	...
	// Edited by Hein Htet Aung Aug11,2016
	function getAllInvoice_h($group, $id, $limit = null, $offset = null, $search = null, $agent_search = null, $funder_search = null) {
		...
		if($agent_search!=null){
			$where = $where." and invoice.agent_id=".$agent_search;
		}
		if($funder_search!=null){
			$where = $where." and invoice.customer_id=".$funder_search;
		}

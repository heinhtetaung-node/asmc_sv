 ...
 -->
    <ul id="nav-accordion" class="sidebar-menu">
     ...
     <?php
      ...
      <li class="<?php if ($active =='invoice') echo 'active';?> sub-menu dcjq-parent-li"> <a href="<?php echo base_url();?>invoice" class="<?php if ($active =='invoice') echo 'active';?> dcjq-parent">Invoice List</a>
       
      </li>
      <li class="<?php if ($active =='addinvoice') echo 'active';?> sub-menu dcjq-parent-li"> <a href="<?php echo base_url();?>invoice/addInvoice" class="<?php if ($active =='addinvoice') echo 'active';?> dcjq-parent">Add Invoice</a>
      ...
      <li>
       ...
       <li class="<?php if ($active =='commision') echo 'active';?> sub-menu dcjq-parent-li"> <a href="<?php echo base_url();?>commission" class="<?php if ($active =='commision') echo 'active';?> dcjq-parent">Commision</a>

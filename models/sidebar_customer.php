 ...
 -->
    <ul id="nav-accordion" class="sidebar-menu">
     ...
     <li>
      ...
      <li class="<?php if ($active =='invoice') echo 'active';?> sub-menu dcjq-parent-li"> <a href="<?php echo base_url();?>customerinv" class="<?php if ($active =='invoice') echo 'active';?> dcjq-parent">Invoice List</a>

    ...
    <div class="block-web">
      ...
      <div style="background:#fff;">
        <form action="<?php echo base_url();?>login" method="post" class="form-horizontal" style="margin-bottom: 0px !important;">
            ...
            <div class="form-group">
              ...
              <?php echo form_error('useremail'); ?>
                <div class="input-group"> <span class="input-group-addon"><i class="fa fa-user"></i></span>
                  <input type="text" class="form-control" id="username" name="useremail" value="<?php echo set_value('useremail', $useremail);?>" placeholder="Email">
                </div>
              </div>
            </div>
            <div class="form-group">
          ...
          <div class="foot">
            <a href="<?php echo base_url();?>login"><button type="submit" data-dismiss="modal" class="btn btn-primary">Log in</button></a>
          </div>
        </form>
      </div>
    </div>
